...
class NewsPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.mute_button = QPushButton("今日静音")
        self.mute_button.setObjectName("quietButton")
        self.mute_button.clicked.connect(self.mute_today_requested.emit)
    ...
    def _create_item(self, item, time_text):
        ...
        title.setObjectName("newsItemTitle")
        ...
        if summary_text:
            ...
            summary.setObjectName("newsSummary")

...
class SettingsDialog(QDialog):
    def __init__(self, win: FloatLabel, parent: QWidget, app=None):
        ...
        news_cfg = NewsSource.normalize_news_alert_config(getattr(self.win, "news_alert_config", {}))
        g_news_source = QGroupBox("实时消息")
        ...
        self.cmb_news_interval = QComboBox()
        ...
        self.spin_news_mini_font.setRange(9, 20)
        self.spin_news_mini_font.setSuffix(" pt")
        self.spin_news_mini_font.setToolTip("仅调整迷你资讯窗口的文字大小")
        ...
        self.lbl_news_mini_font = QLabel("迷你字号")
        mini_style_row.addWidget(self.lbl_news_mini_font)
    ...
    def _on_news_alert_config_changed(self, *_args):
        self._sync_news_alert_enabled()
        ...
        if callable(setter):
            ...
            self.win.news_alert_config = config
